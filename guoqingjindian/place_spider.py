...
def spider_place(keyword, page):
    ...
    :return:
    """
    # url1= 'https://piao.qunar.com/ticket/list.json?keyword=&%E5%9B%BD%E5%BA%86%E6%97%85%E6%B8%B8%E6%99%AF%E7%82%B9region=&from=mpl_search_suggest&page=4'
    url = 'http://piao.qunar.com/ticket/list.json?keyword={}&region=&from=mpl_search_suggest&page={}'.format(keyword,page)
    # print(url1)
    headers = {
    ...
    print(place_list,'11111111111111111111')
    # 保存景点信息
